...
@section('content')
    <div class="space-y-8">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-white tracking-tight">Edit Year</h1>
            <p class="text-zinc-400 mt-1 uppercase text-[10px] font-black tracking-widest">{{ $year->year }}</p>
        </div>
