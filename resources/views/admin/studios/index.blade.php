...
@section('content')
    <div class="space-y-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
                <h1 class="text-3xl font-bold text-white tracking-tight">Animation Studios</h1>
                <p class="text-zinc-400 mt-1 uppercase text-[10px] font-black tracking-widest">Creators & Production Houses
                </p>
            </div>
