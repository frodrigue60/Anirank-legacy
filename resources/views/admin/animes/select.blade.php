    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
            @foreach ($animes as $anime)
                @php
                    $title = $anime->title->romaji ?? ($anime->title->english ?? 'Untitled');
                    $anirank_id = ['id' => $anime->id];
                @endphp
                <div
                    ...
                    <div class="aspect-3/4 relative overflow-hidden">
                        ...
                        <div
                            ...
                            <a href="{{ route('admin.animes.by.id', $anirank_id) }}"
                    ...
                    <a href="{{ route('admin.animes.by.id', $anirank_id) }}" class="absolute inset-0 z-10"
