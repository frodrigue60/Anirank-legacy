...
<div class="space-y-6 max-w-2xl mx-auto">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-white tracking-tight">Create Genre</h1>
            <p class="text-zinc-400 mt-1 uppercase text-[10px] font-black tracking-widest">Add a new anime genre</p>
        </div>
