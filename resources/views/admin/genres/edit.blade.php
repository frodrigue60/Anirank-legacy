...
<div class="space-y-6 max-w-2xl mx-auto">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-white tracking-tight">Edit Genre</h1>
            <p class="text-zinc-400 mt-1 uppercase text-[10px] font-black tracking-widest">Update properties for {{ $genre->name }}</p>
        </div>
...
<script>
    document.getElementById('name').addEventListener('input', function() {
        // Only auto-generate if the slug was empty or matching the name previously to avoid unwanted overrides
