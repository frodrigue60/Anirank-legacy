        ...
        <div class="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-3xl shadow-xl overflow-hidden p-8">
            <form method="post" action="{{ route('admin.songs.update', $song->id) }}" enctype="multipart/form-data"
                    ...
                    <script>
                        function postAutocomplete() {
                            return {
                                search: '',
                                results: [],
                                selectedId: {{ $song->anime_id ?? 'null' }},
                                selectedTitle: '{{ $song->post ? addslashes($song->anime->title) : '' }}',
                                loading: false,
                                showResults: false,
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="artists" id="artists-input"
                        value="{{ old('artists', $artists_string) }}" required
