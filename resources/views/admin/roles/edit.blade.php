...
@section('content')
    <div class="space-y-8">
        ...
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-white tracking-tight">Modify Role</h1>
            <p class="text-zinc-400 mt-1 uppercase text-[10px] font-black tracking-widest">{{ $role->name }} Identification
            </p>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" id="nameRole" required
                        ...
                        <div class="space-y-2">
                            <label for="slugRole"
                                ...
                                (Optional)</label>
                            <input type="text" name="slug" id="slugRole" value="{{ old('slug', $role->slug) }}"
                                class="block w-full bg-zinc-950/50 border border-zinc-800 text-white rounded-2xl px-4 py-3 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all text-sm h-12"
                                placeholder="e.g. moderator">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="description" id="descriptionRole" rows="4"
                            ...
                            placeholder="Describe the responsibilities of this role...">{{ old('description', $role->description) }}</textarea>
                    </div>
                </div>
