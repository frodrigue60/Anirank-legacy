    ...
    <div class="space-y-8">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-3xl shadow-xl overflow-hidden p-6">
                <form action="{{ route('admin.artists.index') }}" method="GET" class="relative group">
                            ...
                            @foreach ($artists as $artist)
                                <tr class="hover:bg-zinc-800/30 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <a class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-zinc-800 text-zinc-300 border border-zinc-700"
                                            href="{{ route('admin.songs.index', ['artist_id' => $artist->id]) }}">
